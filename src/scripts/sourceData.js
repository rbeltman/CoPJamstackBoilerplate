...
const client = contentful.createClient({
    space: 'uj4ynh6h7p69', // Insert Contentful Space ID
    accessToken: '9ATWt4NsGkl2d_Nqw158v1KSpK0i5affvkyowUpuZ_M' // Insert Contentful Content Delivery API access token
});
